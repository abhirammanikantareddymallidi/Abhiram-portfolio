...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 md:py-32 px-6 md:px-8 bg-neutral-950/50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-16 items-start">
          <div className="md:w-1/3 md:sticky md:top-32 w-full">
            ...
            <h3 className="text-4xl sm:text-5xl font-bold mb-8 italic">ABOUT<br />ME<span className="text-blue-600">.</span></h3>
          ...
          <div className="md:w-2/3 w-full grid grid-cols-1 gap-12">
            <div className="bg-white/5 border border-white/5 rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-12 hover:border-blue-500/30 transition-all group">
            ...
            <div className="bg-white/5 border border-white/5 rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-12 hover:border-blue-500/30 transition-all group">
              ...
              <div className="space-y-12">
                <div className="relative pl-8 border-l border-blue-500/30">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start items-start gap-1 sm:gap-4 mb-2">
                    <h5 className="text-xl font-bold">B.Tech in Electrical and Electronics Engineering</h5>
                    <span className="text-xs font-mono text-slate-500 whitespace-nowrap">2024 — Present</span>
                  </div>
                ...
                <div className="relative pl-8 border-l border-blue-500/30">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start items-start gap-1 sm:gap-4 mb-2">
                    ...
                    <span className="text-xs font-mono text-slate-500 whitespace-nowrap">2021 — 2022</span>
                  </div>
